...
function ToggleDisplayMenu(){
	...
	if(idxPos!=1000){		
		 $('<li class="page_item" id="additional_menu"><a title="Show Menu" onclick="return toggleMenu(this);" href="#" target="">Show >></a></li>').insertAfter($('#pagenav ul').children(':eq('+(idxPos)+')'));
...
function redirectPage(pageid){
	self.location.href="index.php?pageid="+pageid;
}
...
if (dashboardMenu !== null) {
    dashboardMenu.innerHTML = "<a href='/'>Home</a>";
}